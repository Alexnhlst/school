// converte un indirizzo IPv4 nella notazione ASCII
...
// restituisce -1 in caso di error, 0 in caso di successo
int UDP_init(unsigned short port_number);

// trasmette al socket identificato dall'indirizzo IP e dal numero
// di porta UDP un numero N_byte di dati contenuti nel buffer data
...
// restituisce -1 in caso di errore o di dati non disponibili, o
...
int UDP_receive(unsigned long *ip_address,
